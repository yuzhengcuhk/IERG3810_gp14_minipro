...
void start_game()
{
	...
	{	
		...
		if (period > 0 && period++ >= 20){period = 0; speed = 100;}
		//Show the remaining number of slow items
		for(i=0;i<10;i++)
		{IERG3810_TFTLCD_ShowChar(i*9+10, 10, item_msg[i], 0, WHITE);}
		IERG3810_TFTLCD_ShowChar(i*9+20, 10, item_count, 0, WHITE);
